...
public class AdultDiapers extends SubsystemBase {
    ...
    /**
     * Moves the climber up at a speed specified in the instance variable MoveSpeed for general
     * control
     * 
     * @return void
     * @version 1.0
    ...
    /**
     * Moves the climber down at a speed specified in the instance variable MoveSpeed for general
     * control
     * 
     * @return void
     * @version 1.0
    ...
    /**
     * Slowly moves the climber up at a speed specified in the instance variable slowMoveSpeed for
     * fine control
     * 
     * @return void
     * @version 1.0
    ...
    /**
     * Slowly moves the climber down at a speed specified in the instance variable slowMoveSpeed for
     * fine control
     * 
     * @return void
     * @version 1.0
